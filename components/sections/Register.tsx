...
export default function Register() {
    ...
    if (status === 'success') {
        return (
            <div className="min-h-screen pt-32 pb-20 px-4 md:px-8 max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
                <CheckCircle2 className="w-24 h-24 text-[#dc2626] mb-8 animate-pulse" />
    ...
    return (
        <div className="min-h-screen pt-32 pb-20 px-4 md:px-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#dc2626]/5 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#dc2626]/5 rounded-full blur-[120px] pointer-events-none" />

            <div className="max-w-4xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 font-orbitron heading-glow tracking-tighter">
                        REGISTER FOR <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#dc2626] to-[#fecaca]">Hack[AI]Thon 2.0</span>
                    </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-12 backdrop-blur-md bg-black/40 p-8 md:p-12 rounded-2xl border border-white/5 shadow-2xl relative">
                    <div className="absolute -top-px left-10 right-10 h-px bg-gradient-to-r from-transparent via-[#dc2626]/50 to-transparent" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#dc2626] focus:ring-1 focus:ring-[#dc2626] transition-colors font-rajdhani text-lg"
                                ...
                                <div className="flex bg-white/5 border border-white/10 rounded-lg p-1">
                                    {[2, 3, 4].map(size => (
                                        <button
                                            ...
                                            className={`flex-1 py-2 text-lg font-rajdhani rounded-md transition-all ${memberCount === size ? 'bg-[#dc2626] text-white font-bold shadow-[0_0_15px_rgba(220,38,38,0.5)]' : 'text-gray-400 hover:text-white'}`}
                                        >
                                            {size}
                                        </button>
                                    ))}
                    ...
                    <div className="space-y-8">
                        ...
                        {members.map((member, idx) => (
                            <div key={idx} className="relative bg-white/[0.02] border border-white/5 p-6 rounded-xl group hover:border-[#dc2626]/30 transition-colors">
                                <div className="absolute -left-3 -top-3 w-8 h-8 bg-black border border-[#dc2626]/50 rounded-full flex items-center justify-center font-orbitron text-[#dc2626] font-bold text-sm">
                                    {idx + 1}
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-black/50 border border-white/10 rounded-lg pl-11 pr-4 py-3 text-white focus:outline-none focus:border-[#dc2626] transition-colors"
                                        />
                                    </div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-black/50 border border-white/10 rounded-lg pl-11 pr-4 py-3 text-white focus:outline-none focus:border-[#dc2626] transition-colors appearance-none"
                                        >
                                    ...
                                    <div className="relative md:col-span-2">
                                        <input
                                            ...
                                            className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#dc2626] transition-colors"
                                        />
                                    </div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#dc2626] transition-colors appearance-none"
                                        >
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-[#dc2626] to-[#fecaca] translate-y-[100%] group-hover:translate-y-0 transition-transform duration-300" />
                        <div className="bg-white/5 border border-[#dc2626]/50 text-white font-orbitron text-xl py-4 px-8 flex items-center justify-center gap-4 relative z-10 group-hover:text-black transition-colors duration-300">
