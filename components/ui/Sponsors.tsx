...
export default function Sponsors() {
  return (
    <section
      id="sponsors"
      className="min-h-[80vh] flex items-center relative overflow-hidden py-28 md:py-36"
    >
      <div className="container mx-auto px-6 relative z-10">
        <div className="cinematic-panel cinematic-panel-left max-w-5xl p-8 md:p-10">
          {/* Heading */}
          ...
          >
            ...
            <a
              href="mailto:partnerships@spherehive.in?subject=Hack[AI]Thon%202.0%202026%20Sponsorship"
