    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="pt-24 sm:pt-36 flex justify-center px-4"
        >
          <span className="font-mono text-[5.5px] min-[360px]:text-[6.5px] min-[390px]:text-[7.2px] min-[420px]:text-[7.8px] sm:text-[9px] md:text-[10px] tracking-[0.08em] sm:tracking-[0.3em] md:tracking-[0.5em] uppercase text-white/45 text-center max-w-full whitespace-nowrap block">
            KVGCE, Sphere Hive X VRIF VTU Belagavi · Presents
          </span>
        </motion.div>

        {/* Spacer that lets the background breathe */}
        <div className="flex-grow max-h-[80px] sm:max-h-none" />
