          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 border-t border-white/10 pt-12">
            ...
            >
              <div>
                ...
                <p className="text-[13px] text-white/70 leading-relaxed mb-6 font-light">
                  This is where 3LC.ai comes in. Finalists participate online
                  through VRIF VTU Belagavi, building data pipelines and using
                  3LC to systematically identify, select, and correct data to
